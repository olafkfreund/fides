...
**[Getting Started guide](getting_started.md)** or the Helm chart
...
* **[Getting Started](getting_started.md)** — run the full stack locally with Docker Compose and walk the CLI.
* **[Setup & Seeding](setup.md)** · **[CLI reference](cli-reference.md)** · **[MCP server](mcp-server.md)**
